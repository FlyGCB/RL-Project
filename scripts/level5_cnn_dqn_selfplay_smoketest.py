...
CNN_DQN_CONFIG = {
    ...
    "batch_size": 64,
    "min_buffer_size": 500,  # smoke test: shrunk from 5_000 so optimize() actually runs
    "target_update_steps": 2_000,
    "train_frequency": 4,
}

N_EPISODES_5A = 20  # smoke test: shrunk from 1500
FORCED_RANDOM_EPISODES_5A = 5  # smoke test: shrunk from 200
TRAIN_SEED = 0
...
SAVE_PATH_5A = SAVE_DIR / "cnn_dqn_level5_5a_smoketest.pt"
...
P_LIVE = 0.8
SNAPSHOT_EVERY = 5  # smoke test: shrunk from 200
N_EPISODES_5B = 20  # smoke test: shrunk from 1500
...
SAVE_PATH_5B = SAVE_DIR / "cnn_dqn_level5_selfplay_smoketest.pt"
